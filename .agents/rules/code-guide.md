...
- Always use `npm run lint` to test your work before marking a task complete.
- Fix any errors that come up.
- Do not run `build` or similar commands. Inform the user they should do that manually, if you feel it neccessary.
